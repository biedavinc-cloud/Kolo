...
// Écran affiché à la fin de l'essai gratuit : paiement d'un plan pour continuer
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-background px-4 py-12">
      ...
      <p className="mt-2 max-w-md text-center text-sm text-muted-foreground">
        Choisissez un plan pour continuer à utiliser Kolo avec votre foyer. Votre argent, vos budgets
        et vos objectifs vous attendent — tout est conservé.
      </p>
